...
class Type extends Model
{
	...
	public function GetDataForDataTable()
	{
		...
		$totalData->leftJoin('users', 'types.created_by', '=', 'users.id');
		$filterData->leftJoin('users', 'types.created_by', '=', 'users.id');
		$totalCount->leftJoin('users', 'types.created_by', '=', 'users.id');
		...
		$totalData = $totalData->selectRaw('types.id, types.name as typeName, users.name as userName, types.description, types.status')->get();
